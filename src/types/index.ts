...
export interface UserSettings {
  ...
  salawatTarget?: number; // daily target count
  salawatReminder?: boolean; // enable reminder
  ...
  adhanType?: string; // alternate adhan setting
  pushEnabled: boolean; // push notifications when app is closed
  notificationPermission?: string; // browser notification permission
}
